...
if __name__ == "__main__":
    ...
    img_train_list = read_dir(args.data_dir + 'train/')

    tfrecords_train_name = 'train.tfrecord'

    epochs = 2
    batch_size = 4
    min_after_dequeue = 10

    show_samples(DATA_DIR, img_train_list, tfrecords_train_name, epochs, batch_size, min_after_dequeue)